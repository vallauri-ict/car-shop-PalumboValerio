...
namespace VenditaVeicoliDLLProject
{
    class OpenXMLClass
    {
        public static void createDocument(string filepath = "test.docx", string msg = "Hello, World!")
        {
            using (WordprocessingDocument doc = WordprocessingDocument.Create(filepath, WordprocessingDocumentType.Document))
            {
                ...
                // Add your paragraph to docx body
                body.Append(createJustification());

                // Add your heading
                addHeading1Style(mainPart);
                body.Append(createHeading("Ciao"));
        ...
        public static Paragraph createJustification()
        {
            Paragraph p = new Paragraph();
